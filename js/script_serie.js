...
document.addEventListener("DOMContentLoaded", async () => {
    ...
    async function fetchOpere() {
        try {
            const response = await fetch("../data/serie.json"); // Percorso del file JSON
    ...
    <div class="modal-body">
        ...
        <p><strong>Anno:</strong> ${opera.data || "Non disponibile"}</p>
        <p><strong>Genere:</strong> ${opera.genere ? opera.genere.join(" | ") : "Non disponibile"}</p>
